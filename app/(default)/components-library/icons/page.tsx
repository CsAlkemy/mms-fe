export const metadata = {
  title: 'Icons - Makers Media Source',
      ...
      <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-[96rem] mx-auto">
        ...
        <div className="border-t border-slate-200 dark:border-slate-700">
          ...
          <div className="space-y-8 mt-8">
            ...
            <div className="text-sm">If you need more icons than what we currently support in Makers Media Source, check out these great packs 👇</div>
            ...
            <div>
              ...
              <div className="px-6 py-8 bg-slate-800 rounded-sm text-center xl:text-left xl:flex xl:flex-wrap xl:justify-between xl:items-center">
                <div className="text-slate-300 mb-4 xl:mb-0 max-w-lg mx-auto xl:mx-0 2xl:max-w-none">99% of the icons used in Makers Media Source come from Nucleo; a huge library of 3K+ vector icons!</div>
            ...
            <div>
              ...
              <div className="px-6 py-8 bg-slate-800 rounded-sm text-center xl:text-left xl:flex xl:flex-wrap xl:justify-between xl:items-center">
                <div className="text-slate-300 mb-4 xl:mb-0 max-w-lg mx-auto xl:mx-0 2xl:max-w-none">A set of 1250+ icons that are visually consistent with the style used in Makers Media Source!</div>
                <div className="inline-flex space-x-3">
