        ...
        <div className="m-1.5">
          ...
          <ModalAction isOpen={integrationModalOpen} setIsOpen={setIntegrationModalOpen}>
            ...
            <div className="mb-5 text-center">
              ...
              <div className="text-lg font-semibold text-slate-800 dark:text-slate-100">Connect Makers Media Source with your Cruip account</div>
            </div>
            {/* Modal content */}
            <div className="text-sm mb-5">
              <div className="font-medium text-slate-800 dark:text-slate-100 mb-3">Makers Media Source would like to:</div>
              ...
              <div className="text-xs text-slate-500">By clicking on Allow access, you authorize Makers Media Source to use your information in accordance with its <a className="text-indigo-500 hover:text-indigo-600 dark:hover:text-indigo-400" href="#0">Privacy Policy</a>. You can stop it at any time on the integrations page of your Makers Media Source account.</div>
            </div>
            {/* Modal footer */}
            <div className="flex flex-wrap justify-end space-x-2">
        ...
        <div className="m-1.5">
          ...
          <ModalBlank isOpen={newsModalOpen} setIsOpen={setNewsModalOpen}>
            <div className="relative">
              <Image className="w-full" src={ModalImage} width={460} height="200" alt="New on Makers Media Source" />
              {/* Close button */}
            ...
            <div className="p-5">
              ...
              <div className="mb-2">
                <div className="mb-3">
                  <div className="text-xs inline-flex font-medium bg-indigo-100 dark:bg-indigo-500/30 text-indigo-600 dark:text-indigo-400 rounded-full text-center px-2.5 py-1">New on Makers Media Source</div>
                </div>
          ...
          <ModalBasic isOpen={planModalOpen} setIsOpen={setPlanModalOpen} title="Change your Plan">
            ...
            <div className="px-5 pt-4 pb-1">
              <div className="text-sm">
                      ...
                      <div className="flex items-center">
                        ...
                        <div className="grow">
                          <div className="flex flex-wrap items-center justify-between mb-0.5">
                            <span className="font-medium text-slate-800 dark:text-slate-100">Makers Media Source Light <span className="text-xs italic text-slate-500 align-top">Current Plan</span></span>
                  ...
                  <li>
                    <button className="w-full h-full text-left py-3 px-4 rounded bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 hover:border-slate-300 dark:hover:border-slate-600 shadow-sm duration-150 ease-in-out">
                      <div className="flex items-center">
                        ...
                        <div className="grow">
                          <div className="flex flex-wrap items-center justify-between mb-0.5">
                            <span className="font-semibold text-slate-800 dark:text-slate-100">Makers Media Source Basic <span className="text-xs italic text-indigo-500 align-top">Best Value ✨</span></span>
                  ...
                  <li>
                    <button className="w-full h-full text-left py-3 px-4 rounded bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 hover:border-slate-300 dark:hover:border-slate-600 shadow-sm duration-150 ease-in-out">
                      <div className="flex items-center">
                        ...
                        <div className="grow">
                          <div className="flex flex-wrap items-center justify-between mb-0.5">
                            <span className="font-semibold text-slate-800 dark:text-slate-100">Makers Media Source Plus</span>
                ...
                <div className="text-xs text-slate-500">Your workspace's Makers Media Source Light Plan is set to $39 per month and will renew on August 9, 2021.</div>
              </div>
            </div>
            {/* Modal footer */}
            <div className="px-5 py-4">
